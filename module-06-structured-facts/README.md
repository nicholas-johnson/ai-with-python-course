...
Each demo is a separate interactive script. All use real OpenAI calls.

```bash
python module-06-structured-facts/demo/01_extraction.py
python module-06-structured-facts/demo/02_graph.py
python module-06-structured-facts/demo/03_grounded_qa.py
```

| Script | What it shows |
|--------|--------------|
| `01_extraction.py` | Pydantic schema, structured extraction, validation filtering |
| `02_graph.py` | Build networkx graph from facts, query entities and paths |
| `03_grounded_qa.py` | Graph-grounded QA with citations, comparison without graph |
...
| ------ | -------------- |
| [`exercises/01-fact-extractor`](exercises/01-fact-extractor/) | Extract structured facts from ship logs with Pydantic + OpenAI |
| [`exercises/02-knowledge-graph`](exercises/02-knowledge-graph/) | Build a networkx knowledge graph and query it interactively |
| [`exercises/03-grounded-qa`](exercises/03-grounded-qa/) | Answer questions grounded in graph evidence with citations |

Run tests for this module:

```bash
pytest module-06-structured-facts/
```

## Slides

From repo root: `pnpm slides:06`, or `cd module-06-structured-facts/slides && pnpm dev`.
