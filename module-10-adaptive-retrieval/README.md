...
The merged, ranked results feed into the grounded prompt builder from Module 6. The answer cites sources from multiple backends — the crew sees evidence from logs, graphs, and documents in a single response.
