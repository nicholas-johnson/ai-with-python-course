...
```bash
python module-11-langchain/demo/01_chains_and_prompts.py
python module-11-langchain/demo/02_langchain_agents.py
python module-11-langchain/demo/03_langchain_rag.py
```
...
```bash
pytest module-11-langchain/
```

## Slides

From repo root: `pnpm slides:11`, or `cd module-11-langchain/slides && pnpm dev`.
