"""
Exercise 02 — Data Tools Agent
Console agent connecting to the data tools MCP server.
(Agent code carried forward from Exercise 01 solution.)
...
SYSTEM_PROMPT = (
    ...
    "crew, sensor, mission, and log queries. Be concise."
)
