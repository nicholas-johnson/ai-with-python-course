...
def build_system_prompt(long_term: LongTermMemory) -> str:
    # TODO: build the BARKEEP system prompt with long-term memories
    #   1. Call long_term.recall() to get active memories
    #   2. Format them into bullet points
    #   3. Return a system prompt that establishes the bartender persona
    #      and includes the memories block
    #   Persona: "You are BARKEEP, the AI bartender at The Nebula's Edge
    #   cantina on Relay Station Omicron..."
    raise NotImplementedError("TODO")
...
def main():
    ...
    print("=== The Nebula's Edge — BARKEEP ===")
