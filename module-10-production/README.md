...
```bash
python module-10-production/demo/01_structured_tracing.py
python module-10-production/demo/02_circuit_breaker.py
python module-10-production/demo/03_deployment_pipeline.py
```
...
```bash
pytest module-10-production/
```

## Slides

From repo root: `pnpm slides:10`, or `cd module-10-production/slides && pnpm dev`.
