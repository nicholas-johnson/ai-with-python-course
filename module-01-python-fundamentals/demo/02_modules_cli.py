...
Run:  python module-01-python-fundamentals/demo/02_modules_cli.py --department science
      python module-01-python-fundamentals/demo/02_modules_cli.py --min-clearance 4
"""
